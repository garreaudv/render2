...
function Calendar() {
  ...
  const firstDayInMonth = new Date(currentYear, currentDate.getMonth(), 1).getDay();

  const daysOfWeek = ['Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa', 'Su'];

  const goToPreviousMonth = () => {
  const previousMonth = new Date(currentYear, currentDate.getMonth() - 1, 1);
        ...
        <div className="md:p-8 p-5 dark:bg-gray-800 bg-white rounded-t">
          <div className="px-4 flex items-center justify-between">
            ...
            <div className="flex items-center">
              <button aria-label="calendar backward" className="focus:text-gray-400 hover:text-gray-400 text-gray-800 dark:text-gray-100" onClick = {goToPreviousMonth}>
                <svg
              ...
              <button aria-label="calendar forward" className="focus:text-gray-400 hover:text-gray-400 ml-3 text-gray-800 dark:text-gray-100" onClick={goToNextMonth}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"

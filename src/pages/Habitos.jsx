...
import '../App.css'
import RecordatorioC from '../componentes/TarjetaRecordatorios'
import TareaC from '../componentes/TarjetaTareas'
import axios from 'axios'
import ModalH from '../componentes/ModalHabitos'
import { AuthContext } from '../auth/AuthContext'
import { useNavigate } from 'react-router-dom'
import ListaClaus from '../componentes/habitos'
        ...
        <div className="grid gap-6 md:grid-cols-1 lg:grid-cols-1">
            ...
            <div>
                <div className="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
                    <h3 className="text-3xl font-bold text-gray-700">Mis Habitos</h3>
                    <table className="w-full text-gray-600">
                    <tbody>
                        {posts
                            
                            .map((post) => (
                            <RecordatorioC nombre={post.nombre_habito} id={post.id} tipo={post.tipo} descripcion={post.descripcion} />
                            ))}
                        </tbody>
                    </table> 
                    <ModalH ></ModalH>
